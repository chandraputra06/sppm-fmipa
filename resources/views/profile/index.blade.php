...
@section('title', 'Profil User - Fakultas MIPA')
        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 mb-6">
                <div class="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
                    <!-- Avatar -->
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name ?? 'N/A') }}&background=3b82f6&color=fff&size=64"
                        ...
                        <div class="flex flex-wrap gap-4 text-gray-600 mb-4">
                            ...
                            @if ($user->role !== '1')
                                <span class="flex items-center">
                                    ...
                                    {{ $user->student?->studyProgram->name }}
                                </span>
                            @endif
                        </div>
